...
public class MediaOption implements Parcelable {
    ...
    private MediaOption(Builder builder) {
    ...
    /**
     * Create default {@link MediaOption} object.
     * <p/>
     * With options:
     * <ul>
     ...
     * @return
     */
    public static MediaOption createDefault() {
        return new Builder().build();
    }

    /**
     *
     * Builder for {@link MediaOption}
     *
     */
    public static class Builder {
        ...
        /**
         * Build configured {@link MediaOption} object.
         *
         * @return
         */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MediaOption other = (MediaOption) obj;
