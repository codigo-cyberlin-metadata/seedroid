...
public class SeedroidTextView extends AppCompatTextView{
    private static final String TYPE_FACE_SMALL = "0";
    private static final String TYPE_FACE_SEMIBOLD = "1";
    private static final String TYPE_FACE_BOLD = "2";
    private Typeface curFace;
    public SeedroidTextView(Context context) {
        super(context);
    }

    public SeedroidTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomTypeFace(context, attrs);
        initView(attrs);
    }

    public SeedroidTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setCustomTypeFace(Context context, AttributeSet attrs)
    {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SeedroidTextView);
