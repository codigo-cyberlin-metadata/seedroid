 ...
 */
public abstract class BasePagerActivity<V extends BaseView, P extends BasePresenter<V>> extends BaseActivity<ViewDataBinding, V, P> implements
    ...
    public int attachLayout() {
        if (!hasHeader) {
            ...
            return R.layout.activity_base_pager_with_header;
        }
    }
